    ...
    <div class="wrapper">
        ...
        <div class="container_main">
            ...
            <div class="main">
                ...
                <form action="./content/content_update.php" method="post">
                    <div class="mt-3 mb-3">
                        <label for="exampleFormControlInput1" class="form-label">タイトル</label>
                        <input type="text" class="form-control" id="exampleFormControlInput1" name="title"
                            placeholder="タイトルを入力ししてください" value="<?= $content['title']; ?>" />
                    </div>
                    ...
                    <div class="mt-3 mb-3">
                        ...
                        <select class="form-select" name="category" aria-label="Default select example">
                            ...
                            <?php if ($menu['menu_name'] == $content['category']) : ?>
                            <option value="<?= $menu['menu_name']; ?>" selected><?= $menu['menu_name']; ?></option>
                            <?php else : ?>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="ckeditor" name="content" style="text-align:left;">
                            <?= $content['content']; ?>
                        </textarea>
                    ...
                    <button class="btn_ok_m mt-3 ring-2 ring-blue-500 bg-blue-200" type="submit">修正</button>
                </form>
